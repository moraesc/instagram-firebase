...
//protocol definition, not an execution
//custom delegation
protocol HomePostCellDelegate {
    func didTapComment(post: Post) //tells you which post you are tapping on
...
class HomePostCell: UICollectionViewCell {
    ...
    fileprivate func setupAttributedCaption() {
        ...
        //add some space between caption and date
    ...
    //cell has a blue image view in it
    ...
    lazy var likeButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(#imageLiteral(resourceName: "like_unselected").withRenderingMode(.alwaysOriginal), for: .normal) //get rid of blue default color
    ...
    override init(frame: CGRect) {
        ...
        //width and height is exact same value
